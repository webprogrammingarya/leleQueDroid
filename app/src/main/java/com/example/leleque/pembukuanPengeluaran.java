...
public class pembukuanPengeluaran extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private TextView pilihanKategori, currentDateTextView, aliranTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aliranTextView = findViewById(R.id.aliran);
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String aliran = aliranTextView.getText().toString();

                new CatatPengeluaranTask().execute(kategori, jumlah, keterangan, tanggal, aliran);
            }
        });
    }
