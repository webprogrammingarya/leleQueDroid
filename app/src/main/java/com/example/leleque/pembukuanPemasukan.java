...
public class pembukuanPemasukan extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private TextView pilihanKategori2, currentDateTextView2, aliranTextView2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aliranTextView2 = findViewById(R.id.aliran2);
        ...
        btnSimpan2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String aliran = aliranTextView2.getText().toString();

                new pembukuanPemasukan.CatatPemasukanTask().execute(kategori, jumlah, keterangan, tanggal, aliran);
            }
        });
    }
    ...
    private class CatatPemasukanTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String aliran = params[4];

            try {
                // Modify the URL to include query parameters
                String pembukuanUrl = PEMBUKUAN_ENDPOINT + "?kategori=" + kategori + "&jumlah=" + jumlah + "&keterangan=" + keterangan + "&tanggal=" + tanggal + "&aliran=" + aliran;
