...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout link_keHalamanArtikel, link_keHalamanVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        link_keHalamanVideo = findViewById(R.id.link_keHalamanVideo);

        link_keHalamanVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
