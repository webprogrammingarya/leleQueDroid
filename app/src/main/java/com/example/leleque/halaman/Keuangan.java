...
public class Keuangan extends AppCompatActivity {
    ...
    private TextView kategoriTextView, jumlahTextView, keteranganTextView, tanggalTextView, aliranTextView;
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < pembukuan.length(); i++) {
                                ...
                                String aliran = obj.optString("aliran", "");
                                ...
                                TextView aliranTextView = new TextView(Keuangan.this);
                                aliranTextView.setText("Aliran: \n" + aliran);
                                aliranTextView.setLayoutParams(new LinearLayout.LayoutParams(
                                        0,
                                        LinearLayout.LayoutParams.WRAP_CONTENT,
                                        1));
...
//                                });
                                ...
                                dataEntryLayout.addView(aliranTextView);
